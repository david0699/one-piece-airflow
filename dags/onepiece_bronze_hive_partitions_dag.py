...
@dag(
    dag_id="onepiece_bronze_hive_partitions_dag",
    start_date=datetime(2024, 1, 1),
    schedule="0 18 * * *",
    catchup=False,
)
def bronze_hive_partitions() -> None:
    @task()
    def add_daily_partitions(ds: str) -> None:
        ...
        payload = _encode_cli_args(
            {
                "mode": bronze_hive_config["ADD_PARTITIONS_MODE"],
    ...
    add_daily_partitions(ds="{{ ds }}")


dag = bronze_hive_partitions()
